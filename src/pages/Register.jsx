            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="John Doe" className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-primary/20 outline-none bg-gray-50" required />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" placeholder="captain@example.com" className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-primary/20 outline-none bg-gray-50" required />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="tel" placeholder="+1 (555) 000-0000" className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-primary/20 outline-none bg-gray-50" required />
                </div>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="password" placeholder="••••••••" className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-primary/20 outline-none bg-gray-50" required />
                </div>
              </div>
            </div>
